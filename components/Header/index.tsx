...
const Header = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-0 z-99999 w-full py-1.5 transition-all duration-300 xl:py-5 ${
        stickyMenu
          ? "border-b border-orange-100 bg-orange-50/95 py-1 shadow-lg backdrop-blur-md xl:py-3 dark:border-gray-800 dark:bg-gray-900/95"
        ...
        <div className="flex items-center justify-start xl:w-1/4">
          <a href="/" className="transition-opacity hover:opacity-80">
            <Image
              ...
              width={150}
              height={50}
              className="hidden h-8 w-auto xl:h-auto xl:w-full dark:block"
            />
            <Image
              src="/images/logo/banner-light.png"
              alt="logo"
              width={150}
              height={50}
              className="h-8 w-auto xl:h-auto xl:w-full dark:hidden"
            />
          </a>
        </div>
