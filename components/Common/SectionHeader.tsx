  ...
  return (
    <>
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        className="animate_top mx-auto text-center px-6 sm:px-8 md:px-12 xl:px-16 2xl:px-20"
      >
        ...
        <h2 className="mx-auto mb-4 text-md font-medium text-black dark:text-white md:w-4/5 xl:w-1/2 xl:text-sectiontitle3">
          {subtitle}
        </h2>
